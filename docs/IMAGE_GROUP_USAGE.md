...
- Показувати **кілька зображень одночасно** з текстовим/діалоговим параграфом
- Використовувати **різні варіанти розкладок** (horizontal-2, horizontal-3, grid-2x2 і т.д.)
