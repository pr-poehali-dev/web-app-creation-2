...
export type MergeLayoutType = 
  ...
  | 'diagonal-split' // диагональное разделение (2 фрейма по диагонали)
  ...
  | 'parallelogram-2' // параллелограммы (2 наклонных фрейма)
  | 'parallelogram-3' // параллелограммы (3 наклонных фрейма)
  | 'zigzag-3' // зигзаг (3 наклонных фрейма)
  | 'diamond-center' // ромб в центре + углы (5 фреймов)
  | 'chevron-2' // шеврон (2 фрейма углом)
  | 'chevron-3'; // шеврон (3 фрейма углом)
