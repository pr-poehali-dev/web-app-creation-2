  ...
  return (
    <div className="absolute top-20 left-4 right-4 bottom-4 md:top-20 md:left-8 md:right-32 rounded-2xl overflow-hidden">
      ...
      <Button
        ...
        className="absolute top-[60px] md:top-4 right-4 z-20 h-10 w-10 p-0 bg-card/80 backdrop-blur-sm hover:bg-card/90 border border-border/50 rounded-full"
      ...
      {!isContentHidden && currentParagraph.type !== 'background' && !isBackgroundChanging && (
        <>
          {hasComicFrames && (
            <div className="absolute top-[60px] left-4 right-4 bottom-[calc(14rem+2rem)] md:top-[80px] md:left-8 md:right-32 md:bottom-[calc(14rem+2rem)] z-10 p-4 overflow-hidden">
