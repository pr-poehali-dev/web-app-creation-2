  ...
  return (
    <>
      {currentParagraph.type === 'text' && (
        <div className={`bg-card/90 backdrop-blur-sm rounded-xl md:rounded-2xl shadow-xl border border-border flex items-center relative ${
          isTopMerged ? 'p-10 md:p-12 lg:p-16 min-h-[35vh] md:min-h-[40vh] lg:min-h-[45vh]' : 'p-4 md:p-6 lg:p-8 min-h-[10rem] md:min-h-[12rem]'
        }`}>
          <div 
          ...
          />
          <div className={`leading-relaxed text-foreground w-full ${
            isTopMerged 
              ? (settings.textSize === 'small' ? 'text-xl md:text-2xl lg:text-3xl text-center' :
                 settings.textSize === 'large' ? 'text-2xl md:text-3xl lg:text-4xl text-center' :
