...
function DialogueBox({ 
  ...
  return (
    <>
      <Card className={`relative bg-card/95 backdrop-blur-sm border-0 shadow-xl ${shouldAnimate ? 'animate-scale-in' : ''} rounded-xl md:rounded-2xl w-full lg:w-[48rem] min-h-[10rem] md:min-h-[12rem]`}>
        <div 
